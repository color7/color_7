...
<tbody><tr><td>
<table width="100%" border="0" cellpadding="0" cellspacing="0">
<tbody><tr><td></td></tr><tr><td>&nbsp;</td><td align="center" style="font-size:15px;text-align:center"><br>您已成功退出系统设置。<br><br><a href="index.php">如果您的浏览器没有自动跳转，请点击这里</a><script>setTimeout("redirect('index.php');", 1250);</script><br><br><br></td><td>&nbsp;</td></tr></tbody></table></td></tr></tbody></table>
